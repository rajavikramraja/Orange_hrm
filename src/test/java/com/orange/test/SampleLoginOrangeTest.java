...
public class SampleLoginOrangeTest extends BaseTest{
...
//}
//
//@Test(enabled = true,dataProvider = "LoginProvide",priority = 1,description = "Valid & Invalid Login")
//public void Login(String userName,String password,String LoginName ) throws InterruptedException {
...
////		
////	}
//	if (logins.loginSuccess() || logins.loginUserNameValid().equalsIgnoreCase(LoginName)) {
//		
//		System.out.println("\nUsername: " + userName + " Password: "+masked +BOLD +"\nValid UserName and Password login SuccessFully"+RESET);
//		Thread.sleep(300);
//		logins.logout();
